module.exports = {
  siteTitle: 'DDM Paddle Boards',
  siteTitleAlt: 'DDM Paddle Boards', // This allows an alternative site title for SEO schema.
  publisher: 'DDM Paddle Boards', // Organization name used for SEO schema
  siteDescription: 'Inflateable Stand-Up Paddle Boards',
  ...
  siteLogo: '/logos/DDM_Paddle_Board_Black.png', // Logo used for SEO, RSS, and App manifest
  backgroundColor: '#e9e9e9', // Used for Offline Manifest
  themeColor: '#121212', // Used for Offline Manifest
  copyright: 'Copyright © 2019 DDM Paddel Boards', // Copyright string for the RSS feed
}
